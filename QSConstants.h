...
#define kAppPrefPath [NSHomeDirectory() stringByAppendingString:@"/Library/Preferences/com.caughtinflux.qspropapplist.plist"]
#define kPrefsDomainName @"com.caughtinflux.qsproprefs"
#define kAppPrefsDomainName @"com.caughtinflux.qspropapplist"

#define kPrefsChangedNotificationName CFSTR("com.caughtinflux.quickshootpro.prefschanged")
#define kAppPrefsChangedNotificationName CFSTR("com.caughtinflux.quickshootpro.prefschanged.appicons")
...
FOUNDATION_EXPORT id         QSObjectFromPrefsForKey(NSString *key);
...
FOUNDATION_EXPORT NSString * QSGetMachineName(void);
